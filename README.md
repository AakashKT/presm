...
Running on WSL requires that we expose the connected FPGA to WSL. Assuming its connected via USB, follow these steps.

Official steps from microsoft are here.
